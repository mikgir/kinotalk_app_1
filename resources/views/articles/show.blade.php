                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="blog-details-wrap">
                            ...
                            <div class="blog-details-content">
                                ...
                                {{--                                </div>--}}
                                <blockquote>
                                    <p>“ Как-то я смешала текилу, абсент и красное вино. Вышло розовеньким. Никогда меня
                                        так не тошнило от любимого цвета ”</p>
                                    <div class="blockquote-cite">
                                        <div class="image">
                                            <img src="{{asset('build/assets/src/assets/img/article/MrsMaisel_6.png')}}"
                                                 alt="img">
                                        </div>
                                        <div class="info">
                                ...
                                <p>Эми Шерман-Палладино бескомпромиссно обозначила магистральное направление движения
                                    героини: Мидж несется вперед не к старомодному «долго и счастливо», а как можно
                                    дальше, в поисках собственной точки хотя бы временного спокойствия. Сложно
                                    загадывать, куда эта заснеженная дорога приведет, в рукаве у создателей еще много
                                    сюрпризов. Допустим, муж Рэйчел Броснахэн Джейсон Ральф, который сыграл продюсера
                                    «Шоу Гордона Форда» и, вероятно, станет одним из центральных персонажей пятого
                                    сезона.
                                    Но если Эми Шерман-Палладино не оступится из-за уговоров публики, то четвёртый сезон
                                    запомнится как шаткий мост к драматичному, болезненному и неоднозначному финалу
                                    одиссеи удивительной миссис Мейзел..</p>
                            </div>
