@can('create-own comments')
    <div class="row bg-transparent mt-3" xmlns:wire="http://www.w3.org/1999/xhtml">
        <div class="blog-avatar-content w-100">
            <form wire:submit.prevent="replyComment({{ $comment->id }})" method="POST"
                ...
                <div class="form-group">
                    <div class="d-flex">
                        ...
                        <div style="width: 100%;">
                            <p>{{ $comment->text }}</p>
                            <textarea wire:model.defer="text" class="fs-5 form-control mx-lg-2 bg-transparent
                                  @error('text') border-red-500 @enderror" type="text" name="text">
                            </textarea>
                        </div>
                    </div>
                    @error('text')
