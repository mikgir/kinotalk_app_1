...
<!-- Form Group (Social type)-->
    <div class="col-auto">
        ...
        <select name="social_type" id="social_type" class="form-select__sel3 form-select form-select-sm mb-3 @error('social_type') border-red-500 @enderror"
    ...
    <div class="col-auto">
        ...
        <input name="social_link" class="form-select__sel3 form-select__inp2 form-select-sm form-control  @error('social_link') border-red-500 @enderror"
