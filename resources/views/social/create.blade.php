...
<!-- Form Group (Social type)-->
    <div class="col-auto">
        <label for="social_type" class="form-label">Категория соц-сети</label>
    ...
    <div class="col-auto">
        ...
        <input name="social_link" class="form-control @error('social_link') border-red-500 @enderror" id="social_link" type="text" placeholder="Добавьте ссылку на страницу" value="">
        @error('social_link')
        <p class="text-red-500">{{$message}}</p>
        @enderror
    </div>
