...
<form method="post" action="{{route('profile.update', $profile->id)}}">
    ...
    <div class="row gx-3 mb-3">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input name="last_name" class="form-control card-header__inp3 @error('last_name') border-red-500 @enderror"
                   id="inputLastName" type="text" value="{{$profile->last_name}}">
            @error('last_name')
            <p class="text-red-500">{{$message}}</p>
            @enderror
        </div>
    ...
    <div class="row gx-3 mb-3">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input name="city" class="form-control card-header__inp3 @error('city') border-red-500 @enderror" id="city" type="text" value="{{$profile->city}}">
            @error('city')
            <p class="text-red-500">{{$message}}</p>
            @enderror
        </div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <input name="country" class="form-control card-header__inp3 @error('country') border-red-500 @enderror" id="country" type="text" value="{{$profile->country}}">
            @error('country')
            <p class="text-red-500">{{$message}}</p>
            @enderror
        </div>
    ...
    <div class="row gx-3 mb-3">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input class="form-control card-header__inp3 @error('birthday') border-red-500 @enderror" id="inputBirthday" type="date" name="birthday" value="{{$profile->birthday}}">
            @error('birthday')
            <p class="text-red-500">{{$message}}</p>
            @enderror
        </div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <textarea class="form-control card-header__inp3 @error('about_me') border-red-500 @enderror" id="about_me" type="text" name="about_me">{{$profile->about_me}}</textarea>
            @error('about_me')
            <p class="text-red-500">{{$message}}</p>
            @enderror
        </div>
