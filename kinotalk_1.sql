...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 16 2023 г., 22:42
...
(1, 11, 5, 'Не все без ума от Мидж: Каким вышел четвертый сезон «Удивительной миссис Мейзел»?', NULL, NULL, '<pre>Одно из главных обстоятельств новых восьми эпизодов, которое может вызвать протест, &mdash; исчезновение центра притяжения.<br>Поначалу им был клуб &laquo;Газлайт&raquo;, во втором сезоне &mdash; курорт Катскилл, окутанный пеленой объяснений с родителями, а в третьем &mdash; турне и навык жизни в дороге.<br>Теперь Мидж отдана самой себе: комикесса находит постоянную работу в нелегальном стриптиз-клубе и отказывается от предложений открывать концерты больших звезд<br>(и даже выступать на разогреве у своей заклятой врагини Софи Леннон).</pre>', NULL, 'ne-vse-bez-uma-ot-midz-kakim-vysel-cetvertyi-sezon-udivitelnoi-missis-meizel', NULL, NULL, 'PENDING', 0, '2023-05-15 21:00:00', '2023-05-16 15:44:09', NULL, 1, 1);
